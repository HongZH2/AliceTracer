...
//    camera.aperture_ = 0.1f;
    ...
    ALICE_TRACER::RectangleXY * rect5 = new ALICE_TRACER::RectangleXY{AVec3(0.f, 0.f, 4.f), AVec2(8.f), &mtl1, &lambert};
    ALICE_TRACER::RectangleYZ * rect1 = new ALICE_TRACER::RectangleYZ{AVec3(3.5f, 0.f, 0.f), AVec2(8.f), &mtl1, &lambert};
    ALICE_TRACER::RectangleYZ * rect2 = new ALICE_TRACER::RectangleYZ{AVec3(-3.5f, 0.f, 0.f), AVec2(8.f), &mtl1, &lambert};
    ALICE_TRACER::RectangleXZ * rect3 = new ALICE_TRACER::RectangleXZ{AVec3(0.f, 3.f, 0.f), AVec2(8.f), &mtl1, &lambert};
    ALICE_TRACER::RectangleXZ * rect4 = new ALICE_TRACER::RectangleXZ{AVec3(0.f, -3.f, 0.f), AVec2(8.f), &mtl1, &lambert};
    ...
    ALICE_TRACER::Material mtl2{AVec3(0.2f)};
    ...
    ALICE_TRACER::TriangleInstance * t1 = new ALICE_TRACER::TriangleInstance{AVec3(0.f, 0.0f, -2.f),
                                                                             AVec3(1.5f),
                                                                             20.f,
                                                                             AVec3(1.f, 0.f ,0.f),
                                                                             &mtl8,
...
//    t1->setTriangleMaterial(0, &mtl2, &lambert);
